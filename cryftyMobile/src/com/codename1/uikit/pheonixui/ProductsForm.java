        ...
        Container destinationsList = new InfiniteContainer() {
            ...
            public Component[] fetchComponents(int index, int amount) {
                ...
                for(int iter = 0; iter < amount; iter++){
                    ...
                    String url = Statics.BASE_URL+"/img/"+products.get(offset).getImg();
                    ...
                    Button buttonCart = new Button(FontImage.MATERIAL_SHOPPING_CART);
                    buttonCart.addActionListener(evt -> {
                        CartService.getInstance().AddToCart(products.get(offset));
                        CartService.getInstance().getProducts().forEach(product -> System.out.println(product.getName()));
                    });
